...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/iknowitza/file-vault.svg?style=flat-square)](https://packagist.org/packages/iknowitza/file-vault)
[![MIT Licensed](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Total Downloads](https://img.shields.io/packagist/dt/iknowitza/file-vault.svg?style=flat-square)](https://packagist.org/packages/iknowitza/file-vault)
...
```bash
composer require iknowitza/file-vault
```
...
```
php artisan vendor:publish --provider="iknowitza\FileVault\FileVaultServiceProvider"
```
